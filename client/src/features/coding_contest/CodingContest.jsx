  ...
  const parsedResult = useMemo(() => {
    ...
    return {
      ...
      status: overallResult.includes("ACCEPTED")
        ? "accepted"
        : overallResult.includes("WRONG ANSWER")
        ? "wrong"
        : "error",
    };
  }, [result]);
    ...
    <span>
      Line: {code.split("\n").length}, Chars: {code.length}
        ...
        >
          ...
          >
            Enter a programming topic and select a difficulty level to generate
              ...
              {parsedResult.testCases.map((testCase) => (
                <div
                  ...
                  style={{
                    ...
                    borderRadius: "8px",
                    border: `1px solid ${
                      testCase.passed ? "var(--success)" : "var(--danger)"
                    }`,
