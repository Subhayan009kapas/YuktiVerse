  ...
  const handleSummarize = async () => {
    ...
    try {
      ...
      if (res.data.summary && res.data.summary.trim()) {
        ...
        setError('Unable to generate summary. Please try with a different PDF or check if the PDF contains readable text.');
        setLoading(false);
      }
      ...
      {showSuccess && (
        <div className="success-popup">
          <div className="popup-content">
            ...
            <p>Your PDF has been successfully summarized and is ready for review.</p>
          </div>
        </div>
      )}
          ...
          >
            ...
            <div className="upload-drop-area">
              <div className="upload-icon">
                <div className="upload-icon-bg">
                  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M14 2H6C4.89543 2 4 2.89543 4 4V20C4 21.1046 4.89543 22 6 22H18C19.1046 22 20 21.1046 20 20V8L14 2Z" stroke="var(--accent-primary)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M14 2V8H20" stroke="var(--accent-primary)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M16 13H8" stroke="var(--accent-primary)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M16 17H8" stroke="var(--accent-primary)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M10 9H8" stroke="var(--accent-primary)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </div>
              </div>
            ...
            <div className="upload-status-bar">
              <div className="file-info">
                <span className="file-icon">📄</span>
                <div>
                  <p className="file-name">{pdfFile ? pdfFile.name : "No file selected"}</p>
                  <p className="file-size">{pdfFile ? formatFileSize(pdfFile.size) : ""}</p>
                </div>
              </div>
              {pdfFile && (
                <button
